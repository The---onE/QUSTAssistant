package com.xmx.qust.module.map.amap;
...
import com.xmx.qust.common.data.callback.DelCallback;
...
import com.xmx.qust.common.map.amap.line.Line;
import com.xmx.qust.common.map.amap.line.LineManager;
import com.xmx.qust.common.map.amap.poi.CollectionView;
import com.xmx.qust.common.map.amap.poi.POI;
import com.xmx.qust.common.map.amap.poi.CollectionManager;
import com.xmx.qust.common.map.amap.poi.POIView;
import com.xmx.qust.common.map.amap.poi.POIViewSearchCallback;
import com.xmx.qust.common.map.amap.utils.AMapServicesUtil;
import com.xmx.qust.common.map.amap.utils.AMapUtil;
        ...
        CollectionManager.getInstance().selectAll(new SelectCallback<POI>() {
            ...
            public void success(List<POI> poiList) {
                for (POI poi : poiList) {
                    ...
                    if (iconId != null) {
                        collectionView.addCollection(poi, iconId, 0.5f, 0.5f);
                    } else {
                        collectionView.addCollection(poi);
                    }
                }
